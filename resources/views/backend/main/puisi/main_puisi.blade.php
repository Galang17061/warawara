                ...
                <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                    <div class="d-flex">
                        <div class="breadcrumb">
                            ...
                            <span class="breadcrumb-item active">Main Puisi</span>
                        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    var table = $('.table_datatable').DataTable({
      ...
      serverSide: true,
      ajax: {
          url:'{{ route('main_puisi_datatable') }}',
          error:function(){
            table.DataTable().ajax.reload();
          }
      },
      columns: [
        {data: 'dp_title', name: 'dp_title'},
        {
          sortable: false,
          "render": function ( data, type, full, meta ) {
            var created_date = full.dp_created_at;
            var created_by   = full.dp_karya;
            return '<table>'+
                      '<tr>'+
                        '<th>Tgl Dibuat</th>'+
                        '<td>'+created_date+'</td>'+
      ...
      $('.table_datatable tbody').on( 'click', '.edit_button', function () {
          ...
          location.href=baseUrl+'/main/main_puisi/edit?&id='+data['dp_id']+'&time='+('{{ time() }}');
    ...
    function tambah() {
      location.href=baseUrl+'/main/main_puisi/create';
    }
</script>
@endsection