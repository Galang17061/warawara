...
@section('content')
        ...
        <div class="profile-cover">
          <div class="profile-cover-img" style="background-image: url({{ asset('../assets_backend/images/placeholders/cover.jpg') }})"></div>
          <div class="media align-items-center text-center text-md-left flex-column flex-md-row m-0">
            <div class="mr-md-3 mb-2 mb-md-0">
              <a href="#" class="profile-thumb">
                <img  @if (Auth::user()->m_image == null || Auth::user()->m_image == '')
                          src="{{ asset('../assets_frontend/img/core-img/img_kosong.jpg') }}"
                      @else
                          src="{{ asset('../storage/app/'.Auth::user()->m_image ) }}"
                      @endif class="border-white rounded-circle" width="48" height="48" alt="">
              </a>
            </div>

            <div class="media-body text-white">
                <h1 class="mb-0">{{ $data->m_name }}</h1>
                <span class="d-block">{{ $data->m_address }}</span>
            </div>
